<?php
    ...
    class operacionesBD
    {
        ...
        /*
         *
         * Función para obtener el Id asignado en la consulta anterior. Consultamos la conexion y obtenemos dicho ID
        mediante insert_id. Return para devolver el ID de la consulta anterior.
        */
        function devolverId(){
