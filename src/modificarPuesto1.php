        ...
        <article id="article2">
            ...
            if(isset($_POST["modificar"])){    //Comprueba que exista en botón Enviar.
                ...
                if($conexionBD->filasAfectadas()){
                    echo 'Puesto modificado correctamente<br/>';
                    echo '<a href="modificarPuesto.php">Modificar otro puesto</a>';
                }else{
                    echo 'Se ha producido un error al modificar el Puesto seleccionado.<br/>';
                    echo '<a href="modificarPuesto.php">Volver a intentarlo</a>';
                }
                ...
                while($valor = $conexionBD->recorrerFilas()) {
                    echo '
                    <div id="añadirPuesto">
                        <form action="modificarPuesto1.php" method="POST">
