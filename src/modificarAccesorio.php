            ...
            if(isset($_POST["enviar"])){    //Comprueba que exista en botón Enviar.
                ...
                if($conexionBD->numeroFilas()){
                    while($valor = $conexionBD->recorrerFilas()) {
                        ...
                        echo '<a class="otro" href="modificarAccesorio1.php?accesorio='.$valor["Id_accesorio"].'">Modificar Accesorio</a><br/><br/>';
                        echo '</div>';
                    }
                }else{
                    echo '<div id="divInfo">';
                    echo 'No hay accesorios asociados al puesto seleccionado<br/><br/>';
                    echo '<a class=otro" href="modificarAccesorio.php">Volver</a>';
                    echo '</div>';
                }
