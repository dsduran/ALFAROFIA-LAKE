            ...
            if(isset($_POST["enviar"])){    //Comprueba que exista en botón Enviar.
                ...
                if($conexionBD->numeroFilas()){
                    while($valor = $conexionBD->recorrerFilas()) {
                        echo '<div id="divInfo">';
                        echo '<b><h2>Accesorio '.$valor["Id_accesorio"].'</h2></b><b>Nombre del Accesorio: </b>'.$valor["nombre"].'<br/><b>Precio (día): </b>'.$valor["precio_dia"].'<br/>';
                        echo '<a href="modificarAccesorio1.php?accesorio='.$valor["Id_accesorio"].'">Modificar Accesorio</a><br/><br/>';
                        echo '</div>';
                    }
                }else{
                    echo '<div id="divInfo">';
                    echo 'No hay accesorios asociados al puesto seleccionado<br/>';
                    echo '<a href="modificarAccesorio.php">Volver</a>';
                    echo '</div>';
                }
                ...
                echo'
                    <div id="añadirPuesto">
                        <form id="formularioPuesto" action="modificarAccesorio.php" method="POST">
