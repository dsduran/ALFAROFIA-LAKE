    ...
    <body>
        ...
        <article id="article2">
            ...
            while ($valor = $conexionBD->recorrerFilas()) {
                echo '<div id="divInfo">';
                echo 'Nombre: ' . $valor["nombre"] . '<br/>Correo: ' . $valor["correo"] . '<br/>Nº Telefono: ' . $valor["telefono"] . '<br/><br/>';
                echo '<a class="otro" href="eliminarUsuario1.php?usuario='.$valor["Id_usuario"].'">Eliminar Usuario</a><br/><br/>';
                echo '</div>';
            }
            ?>
        </article>
