...
<article id="article2">
    ...
    if(isset($_POST["modificar"])){    //Comprueba que exista en botón Enviar.
        ...
        if($conexionBD->filasAfectadas()){
            echo 'Accesorio modificado correctamente<br/><br/>';
            echo '<a class="otro" href="modificarAccesorio.php">Modificar otro accesorio</a>';
        }else{
            echo 'Se ha producido un error al modificar el accesorio seleccionado.<br/><br/>';
            echo '<a class="otro" href="modificarAccesorio.php">Volver a intentarlo</a>';
        }
