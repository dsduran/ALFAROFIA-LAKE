    ...
    <article id="article2">
        ...
        if(isset($_POST["enviar"])){    //Comprueba que exista en botón Enviar.
            if(empty($_POST["puestos"] && $_POST["nombre"] && $_POST["descripcion"] && $_POST["precio_dia"])){
                ...
                echo '<a href="añadirAccesorio.php">Volver a intentarlo</a>';
            }else{
                ...
                if($conexionBD->filasAfectadas()){
                    ...
                    echo 'Accesorio añadido al puesto <b>'.$_POST["puestos"].'</b><br/>';
                    echo '<a href="añadirAccesorio.php">Añadir otro accesorio</a>';
                }else{

                    echo 'Se ha producido un error al añadir el Accesorio <br/>';
                    echo '<a href="añadirAccesorio.php">Volver a intentarlo</a>';
                }
            }
            ...
            echo'
                ...
                <form action="añadirAccesorio.php" method="POST">
                   <select name="puestos">
