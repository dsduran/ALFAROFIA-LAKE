    ...
    <body>
        ...
        <article id="article2">
            ...
            if($conexionBD->filasAfectadas()){
                ...
                echo 'El puesto se ha eliminado correctamente.<br/>';
                echo '<a href="eliminarPuesto.php">Eliminar otro Puesto</a>';
            }else{
                echo 'Error al eliminar el Puesto seleccionado.<br/>';
                echo '<a href="eliminarPuesto.php">Volver a intentarlo</a>';
            }
            ?>
        </article>
        <footer>
