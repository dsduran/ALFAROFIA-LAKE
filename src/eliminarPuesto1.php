...
<html>
    ...
    <body>
        ...
        <article id="article2">
            ...
            $consulta = "Delete from puestos Where Id_puesto = '".$_GET["puesto"]."';";
            $conexionBD->ejecutarConsulta($consulta);

            if($conexionBD->filasAfectadas()){

                echo 'El puesto se ha eliminado correctamente.<br/><br/>';
                echo '<a class="otro" href="eliminarPuesto.php">Eliminar otro Puesto</a>';
            }else{
                echo 'Error al eliminar el Puesto seleccionado.<br/><br/>';
                echo '<a class="otro" href="eliminarPuesto.php">Volver a intentarlo</a>';
            }
            ?>
        </article>
        <footer>
