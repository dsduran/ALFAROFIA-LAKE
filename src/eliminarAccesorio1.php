    ...
    <article id="article2">
        <?php
            ...
            if($conexionBD->filasAfectadas()){
                echo '<div id="divInfo">';
                echo 'Accesorio eliminado correctamente<br/><br/>';
                echo '<a class="otro" href="eliminarAccesorio.php">Eliminar otro accesorio</a>';
                echo '</div>';
            }else{
                echo '<div id="divInfo">';
                echo 'Se ha producido un error al eliminar el Accesorio seleccionado.<br/><br/>';
                echo '<a class="otro" href="eliminarAccesorio.php">Volver a intentarlo</a>';
                echo '</div>';
            }
        ?>
    </article>
