                ...
                if(isset($_POST["enviar"])){    //Comprueba que exista en botón Enviar.
                    ...
                    if($conexionBD->numeroFilas()){     //Comprueba el número de filas que contiene el resultado
                        while($valor = $conexionBD->recorrerFilas()){   //recorre las filas resueltas
                            ...
                            echo 'Sesión iniciada para el usuario <b>'.$_SESSION["nombre"].'</b><br/><br/>';
                                ...
                                echo '
                                    <div id="divContenedor">                                  
                                        <div class="divPuestos">
                                            <h2>Gestión de Puestos<h2/><br/>
                                            <a class="otro1" href="añadirPuesto.php">Añadir un Puesto</a><br/><br/>
                                            <a class="otro1" href="modificarPuesto.php">Modificar un Puesto</a><br/><br/>
                                            <a class="otro1" href="eliminarPuesto.php">Eliminar un Puesto</a><br/><br/>
                                            <a class="otro1" href="consultarPuesto.php">Consultar un Puesto</a>
                                        </div>
                                        <div class="divUsuarios">
                                            <h2>Gestión de Usuarios<h2/><br/>
                                            <a class="otro1" href="eliminarUsuario.php">Eliminar un Usuario</a><br/><br/>
                                            <a class="otro1" href="consultarUsuario.php">Consultar un Usuario</a><br/><br/>
                                        </div>
                                        <div class="divAccesorios">
                                            <h2>Gestión de Accesorios<h2/><br/>
                                            <a class="otro1" href="añadirAccesorio.php">Añadir un Accesorios</a><br/><br/>
                                            <a class="otro1" href="modificarAccesorio.php">Modificar un Accesorios</a><br/><br/>
                                            <a class="otro1" href="eliminarAccesorio.php">Eliminar un Accesorios</a><br/><br/>
                                            <a class="otro1" href="consultarAccesorio.php">Consultar un Accesorios</a><br/><br/><br/>
                                            <a class="otro" href="cerrarSesion.php">Cerrar Sesión</a>
                                        </div><br/>  
                                    </div>
                                ';
                            }
                            if($valor["tipo"] == "c"){
                                ...
                                echo '
                                    <div class="divUsuarios">
                                        <h2>Gestión de Reservas<h2/><br/>
                                        <a class="otro1" href="añadirReserva1.php">Realizar una Reserva</a><br/><br/>
                                        <a class="otro1" href="modificarReserva.php">Mis Reservas</a><br/><br/>
                                        <a class="otro1" href="cerrarSesion.php">Cerrar Sesión</a>
                                    </div>
                                ';
                            }
                        }
