        ...
        <article id="article2">
            <?php
                ...
                while ($valor = $conexionBD->recorrerFilas()) {
                    echo '<div id="divInfo">';
                    echo 'Puesto: ' . $valor["nombre"] . '<br/>Capacidad: ' . $valor["capacidad"] . '<br/>Precio/día: ' . $valor["precio_dia"] . '<br/><br/>';
                    echo '<a class="otro" href="eliminarPuesto1.php?puesto='.$valor["Id_puesto"].'">Eliminar Puesto</a><br/><br/>';
                    echo '</div>';
                }
            ?>
        </article>
