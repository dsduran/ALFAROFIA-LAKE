        ...
        <article id="article2">
            <?php
                ...
                while ($valor = $conexionBD->recorrerFilas()) {
                    echo 'Nombre: ' . $valor["nombre"] . '<br/>Capacidad: ' . $valor["capacidad"] . '<br/>Precio/día: ' . $valor["precio_dia"] . '<br/>';
                    echo '<a href="eliminarPuesto1.php?puesto='.$valor["Id_puesto"].'">Eliminar Puesto</a><br/><br/>';
                }
            ?>
        </article>
        <footer>
