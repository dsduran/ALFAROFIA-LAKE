            ...
            <?php
                ...
                if(isset($_POST["enviar"])){    //Comprueba que exista en botón Enviar.
                    ...
                    while($valor = $conexionBD->recorrerFilas()) {
                        ...
                        echo 'Has seleccionado el Puesto '.$valor["nombre"].' para modificar. <br/><br/>';
                        echo '<a class="otro" href="modificarPuesto1.php?puesto='.$valor["Id_puesto"].'">Continuar</a>';
                    }
                    ...
                    ';
                    echo '<a class="otro" href="reservas.php">Volver</a>';
                }
            ?>
        </article>
        <footer>
